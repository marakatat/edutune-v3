...
import { EquationVisualizer } from "@/components/equation-visualizer"
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          >
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
                  SVG to Mathematical Equations
                </span>
              </h1>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                Convert SVG paths to parametric equations that can be plotted to recreate the image
              </p>
            </div>
              ...
              <CardContent>
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="bg-black/60 border border-white/10 mb-6">
                    ...
                    <TabsTrigger value="visualize" disabled={equations.length === 0 && geogebraCommands.length === 0}>
                      Visualize
                    </TabsTrigger>
                  </TabsList>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex space-x-2">
                          ...
                          >
                            {isCommandsCopied ? <Check className="h-4 w-4 mr-2" /> : <Copy className="h-4 w-4 mr-2" />}
                  ...
                  <TabsContent value="visualize">
                    <EquationVisualizer equations={equations} />
                  </TabsContent>
                </Tabs>
              </CardContent>
            ...
            >
              ...
              <MathVisualizer initialEquations={equations} />
            </motion.div>
          </motion.div>
        </div>
      </div>
